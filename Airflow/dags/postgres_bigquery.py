...
BQ_CONN_ID = "Bigquery"
GCS_PROJECT = "alt-school-capstone-project-1"
BQ_DATASET = "ecommerce_data"
BQ_TABLE = "alt-cap-01"
GCS_BUCKET = "altsch_capstone_01"
# Postgres config variables
PG_CONN_ID = "Postgresdefault01"
...
dag = DAG(
    "extract_load_brazilian_ecommerce_dataset",
    default_args=default_args,
    description="Extract Olist ecommerce dataset from PostgreSQL, load to GCS, and then to BigQuery",
...
for table in tables:
    ...
    sql_query = f"SELECT * FROM {PG_SCHEMA}.{table};"
